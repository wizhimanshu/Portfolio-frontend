    ...
    <div style={{ minHeight: '100vh', backgroundColor: '#0a0a0a', display: 'flex' }}>
      ...
      <div style={{ width: '240px', backgroundColor: '#111111', borderRight: '1px solid #1a1a1a', display: 'flex', flexDirection: 'column', position: 'fixed', height: '100vh' }}>
        ...
        <div style={{ padding: '24px', borderBottom: '1px solid #1a1a1a' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
            ...
            <div>
              ...
              <p style={{ color: '#52525b', fontSize: '11px', margin: 0 }}>{admin?.email}</p>
            </div>
          </div>
        </div>
        ...
        <div style={{ padding: '16px 12px', borderTop: '1px solid #1a1a1a' }}>
          <Link to="/" style={{ width: '100%', display: 'flex', alignItems: 'center', gap: '10px', padding: '10px 12px', borderRadius: '8px', backgroundColor: 'transparent', border: '1px solid transparent', color: '#71717a', fontSize: '14px', textDecoration: 'none', marginBottom: '4px' }}>
            <Home size={16} /> Back to Portfolio
          </Link>
          <button onClick={logout} style={{ width: '100%', display: 'flex', alignItems: 'center', gap: '10px', padding: '10px 12px', borderRadius: '8px', backgroundColor: 'transparent', border: '1px solid transparent', color: '#71717a', fontSize: '14px', cursor: 'pointer', transition: 'color 0.2s' }}
